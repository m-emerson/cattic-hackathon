...
CREATE TABLE LISTINGS (LISTINGID INT UNSIGNED NOT NULL AUTO_INCREMENT, TEXTBOOKID INT UNSIGNED NOT NULL, TEXTBOOK_EDITIONID INT UNSIGNED NOT NULL, USERID INT UNSIGNED NOT NULL, PRICE INT NOT NULL, ITEM_CONDITION VARCHAR(20), PRIMARY KEY(LISTINGID));
